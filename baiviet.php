        ...
        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 order-lg-2 order-md-1 order-1">
            <div class="mota_baiviet">
                ...
                <div class="info_tintuc text-center">
                    ...
                    <span class="ngaytao">
                        <?php echo $result['baiviet_date'] ; ?><i
                            class="fa fa-eye"></i><?php echo $result['baiviet_luotxem'] ; ?>
                    </span>
                </div>
                <div class="clear20"></div>
                <div class="mota"></div>
...
<div class="container">
    ...
    <ul class="khac">
        <li><i class="fa fa-angle-double-right"></i><a href="gioithieu.php"
                title="Giới Thiệu Công Ty SX TM XNK  NGK TIẾN THINH PHÁT  "> Giới Thiệu Công Ty SX TM XNK NGK TIẾN THINH
                PHÁT <span>(29/10/2019)</span></a>
        </li>
        <li><i class="fa fa-angle-double-right"></i><a href="gioithieu.php" title="CHÍNH SÁCH CHO ĐẠI LÝ BÁN HÀNG">
                CHÍNH SÁCH CHO ĐẠI LÝ BÁN HÀNG<span>(26/07/2018)</span></a>
        </li>
    </ul>
</div>
<div id="fb-root"></div>

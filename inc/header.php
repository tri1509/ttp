    ...
    <header>
        <div class="container">
                ...
                <div class="right-header">
                    <div class="right-header-bottom" id="right-header-bottom">
                     ...
                     ?>
                        ...
                        ?>
                                            <li class="li-sub-menu-lv2"><a class="link-sub-menu-lv2"
                                                    href="san-pham-theo-thuong-hieu/<?php echo $result_lv2['brand_id'] ?>/<?php echo $result_lv2['brand_id_lv2'] ?>.html"><?php echo $result_lv2['brand_name_lv2']?></a>
                                            </li>
                                            <?php }} ?>
                                        </ul>
                                    </li>
                  ...
                  ?>
                            ...
                            <form action="timkiem.php" method="POST">
                                <div class="search-toggle" id="search-toggle">
                                    <input type="text" placeholder="Bạn muốn mua gì?" name="search_product"
                                        id="search_product" required="" />
            ...
            <div class="show991 sider-bar-tablet">
                <div class="flex-bw">
                    <span style="cursor:pointer;display: inline-block;color: #00502b; height:80px" class="sp-sn"><i
                            class="fas fa-bars fa-2x" onclick="openNav()"></i></span>
                    <span style="cursor:pointer;display: inline-block;color: #00502b; height:80px" class="sp-cn"><i
                ...
                <div id="mySidenav" class="sidenav">
                    <form action="timkiem.php" method="POST">
                        <div class="search-toggle" style="margin-top:30px">
                            <input type="text" placeholder="Bạn muốn mua gì?" name="search_product" id="search_product"
                                required="" />
                    ...
                    <ul class="menu-mobile" id="accordion">
                        ...
                        <li class="hassub-mb panel">
                            <p class="phelp"><a href="sanpham.html">Sản phẩm</a><a data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapseOne" class="a-icon"><i
                                        class="fas fa-angle-down"></i></a></p>
                            <ul class="sub-menu-mb accordion-collapse panel-collapse collapse mobile-menu-list"
                     ...
                     ?>
                        ...
                        <li class="hassub-mb panel">
                            <p class="phelp"><a href="sanpham.html">Thương hiệu</a><a data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapseTwo" class="a-icon"><i
                                        class="fas fa-angle-down"></i></a></p>
                            <ul class="sub-menu-mb accordion-collapse panel-collapse collapse mobile-menu-list"
                                id="flush-collapseTwo" aria-labelledby="flush-headingTwo"
                                data-bs-parent="#accordionFlushExample">
                                <?php
                        $show_brand = $brand->show_brand();
                        if($show_brand){

    ...
    <div class="float-icon-hotline">
        <ul class="left-icon hotline">
            <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton"
                    href="https://zalo.me/1564877899215390212?gidzl=KXjJ0aTfLG1M1LG2GNDS1r03MWTV8bbHJGPQNGXy2r1C2mDJ22m1K1zV1rm9AmPS6Gq636GXGZ0qGM1R3m"><i
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    ...
                    <p class="clwhite">
                        <a href="/index.php" title="Trang chủ salanest"></a> SALANEST.COM là trang thông tin chia sẻ
                        kiến thức về YẾN SÀO hoạt động phi lơi nhuận. Chúng tôi kinh doanh trực tiếp trên internet. Vui
                        lòng đến trực tiếp Web bán hàng hoặc đến các cửa hàng và hệ thống.<a href="#"
                            title="Trang chủ salanest">SALANEST.COM .</a>
                    </p>
                </div>
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <p class="footer_cs"><a href="bai-viet/1.html" title="Gioi-thieu-cong-ty.">- Giới thiệu Công ty TIẾN
                            THỊNH PHÁT GROUP.</a></p>
                    <p class="footer_cs"><a href="bai-viet/2.html" title="Phuong-thuc-thanh-toan">- Hướng Dẫn Phương
                            Thức Thanh Toán</a></p>
                    <p class="footer_cs"><a href="bai-viet/3.html" title="Hinh-thuc-van-chuyen">- Hình Thức Vận Chuyển &
                            giao hàng.</a></p>
                    <p class="footer_cs"><a href="bai-viet/4.html" title="Chinh-sach-bao-mat">- Chính sách bảo mật thông
                            tin khách hàng.</a></p>
                    <p class="clwhite">
                        <a href="/index.php" title="Trang chủ salanest"></a> <a href="#"
                            title="Trang chủ salanest">SALANEST.COM .</a>
                    </p>
                </div>
                <div class="clear20 show767"></div>

        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 order-lg-1 order-md-2 order-2">
					...
					?>
                            <a href="san-pham-theo-danh-muc/<?php echo $result_showCat['category_id'] ?>.html"
                                class=""><img
                                    src="./img/diamond.png"><span><?php echo $result_showCat['category_name'] ?></span></a>
                            <?php }} ?>
                            ...
                            <a href="chitietsp.php?proid=<?php echo $result['sanpham_id'] ?>"
                                ...
                                <div class="item-pro">
                                    ...
                                    <div class="ct-item-pro">
                                        <p class="bold"><a
                                                href="chitietsp.php?proid=<?php echo $result['sanpham_id'] ?>"
